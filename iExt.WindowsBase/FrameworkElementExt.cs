...
namespace System.Windows
{
    ...
    public static class FrameworkElementExt
    {
        ...
        public static ImageSource Screenshot(this FrameworkElement element,
            double dpiX, double dpiY, PixelFormat format)
        {
            if (null == element)
            {
            ...
            var source = new RenderTargetBitmap(width, height, dpiX, dpiY, format);
        ...
        public static ImageSource Screenshot(this FrameworkElement element)
        {
            ...
            return Screenshot(element, dpiScale.DpiScaleX, dpiScale.DpiScaleY, format);
        }
    }
}
